---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-carrier, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-carrier`.
...
- Checkout local: `app-community/modules/controleonline/ui-carrier`
